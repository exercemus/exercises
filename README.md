...
You can use the exercise data directly in your code from here (yes, it is really this simple):
https://raw.githubusercontent.com/exercemus/exercises/main/exercises-minified.json

## NOTICE
This list is still a WIP, so please expect duplicates (until ~September 2022) until I can manually remove them. However, feel free to use the data as-is.
...
- `video` as a `string?` url (YouTube used when possible)
